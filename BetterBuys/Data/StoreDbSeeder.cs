    ...
    public class StoreDbSeeder
    {
        ...
        static IEnumerable<Product> GetPreconfiguredProducts()
        {
            return new List<Product>
            {
                ...
                new Product("Simple Bench", "The Simple Collection explores living materials, purity of form and the quiet beauty of private spaces. The Simple Bench is made from pure, honest materials including solid, oil-rubbed domestic hardwoods, machined brass and pure aniline leather. The bench works as a stand alone piece or pairs exquisitely with other items in the collection.", 4800m, "/images/products/bench4.jpg"),
                new Product("Inheritance Bench - Wool", "Los Angeles based designer Stephen Kenn has long been inspired by clean and simple design aesthetics and the stories inherent in vintage military fabrics. In 2011 he combined those two loves by creating The Inheritance Collection. The collection was the result of an exploration of how furniture is constructed, and then a desire to distill the process down to the barest bones. Likening the process of furniture construction to the way the human body is constructed, the frame, belts, and cushions became the bones, muscles, and skin of each piece", 3800m, "/images/products/bench5.jpg")
            };
        }
